// Lấy phần tử chứa chi tiết sản phẩm
...
fetch(`http://localhost:3000/api/productdetail/${productId}`)
        ...
        detail.innerHTML = `
            <div class="row px-xl-5">
                    ...
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner border">
                            <div class="carousel-item active">
                                <img class="w-100 h-100" src="http://localhost:3000/images/anh.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">Giá</h3>
    ...
    // Show favourite
   // Show favourite
// const favourite = document.getElementById('load-favourite');
...
//                 <img class="img-fluid w-100" src="http://localhost:3000/images/${product.img}" alt="">
//             </div>
